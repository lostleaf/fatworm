// $ANTLR 3.4 Fatworm.g 2014-04-10 23:02:52
 package parser; 
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public String getGrammarFileName() { return "Fatworm.g"; }
    ...
    // Fatworm.g:32:1: statement : ( database_statement | table_statement | insert_statement | delete_statement | update_statement | index_statement | select_statement );
    public final FatwormParser.statement_return statement() throws RecognitionException {
        ...
        FatwormParser.database_statement_return database_statement1 =null;

        FatwormParser.table_statement_return table_statement2 =null;

        FatwormParser.insert_statement_return insert_statement3 =null;

        FatwormParser.delete_statement_return delete_statement4 =null;

        FatwormParser.update_statement_return update_statement5 =null;

        FatwormParser.index_statement_return index_statement6 =null;

        FatwormParser.select_statement_return select_statement7 =null;
        ...
        try {
            ...
            // Fatworm.g:33:3: ( database_statement | table_statement | insert_statement | delete_statement | update_statement | index_statement | select_statement )
            int alt1=7;
            switch ( input.LA(1) ) {
            case CREATE:
            case DROP:
    ...
    // Fatworm.g:42:1: database_statement : ( CREATE DATABASE db_name -> ^( CREATE_DATABASE db_name ) | USE db_name -> ^( USE_DATABASE db_name ) | DROP DATABASE db_name -> ^( DROP_DATABASE db_name ) );
    public final FatwormParser.database_statement_return database_statement() throws RecognitionException {
        ...
        FatwormParser.db_name_return db_name10 =null;

        FatwormParser.db_name_return db_name12 =null;

        FatwormParser.db_name_return db_name15 =null;
        ...
        try {
            ...
            // Fatworm.g:43:3: ( CREATE DATABASE db_name -> ^( CREATE_DATABASE db_name ) | USE db_name -> ^( USE_DATABASE db_name ) | DROP DATABASE db_name -> ^( DROP_DATABASE db_name ) )
            int alt2=3;
            switch ( input.LA(1) ) {
            case CREATE:
                {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    // 44:5: -> ^( CREATE_DATABASE db_name )
                    {
                        ...
                        (Object)adaptor.create(CREATE_DATABASE, "CREATE_DATABASE")
                        , root_1);
                ...
                case 2 :
                    ...
                    // 46:5: -> ^( USE_DATABASE db_name )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(USE_DATABASE, "USE_DATABASE")
                        , root_1);
                ...
                case 3 :
                    ...
                    // 48:5: -> ^( DROP_DATABASE db_name )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(DROP_DATABASE, "DROP_DATABASE")
                        , root_1);
    ...
    // Fatworm.g:51:1: table_statement : ( CREATE TABLE tbl_name '(' create_definition ( ',' create_definition )* ')' -> ^( CREATE_TABLE tbl_name ( create_definition )* ) | DROP TABLE tbl_name ( ',' tbl_name )* -> ^( DROP_TABLE ( tbl_name )* ) );
    public final FatwormParser.table_statement_return table_statement() throws RecognitionException {
        ...
        FatwormParser.tbl_name_return tbl_name18 =null;

        FatwormParser.create_definition_return create_definition20 =null;

        FatwormParser.create_definition_return create_definition22 =null;

        FatwormParser.tbl_name_return tbl_name26 =null;

        FatwormParser.tbl_name_return tbl_name28 =null;
        ...
        try {
            ...
            // Fatworm.g:52:3: ( CREATE TABLE tbl_name '(' create_definition ( ',' create_definition )* ')' -> ^( CREATE_TABLE tbl_name ( create_definition )* ) | DROP TABLE tbl_name ( ',' tbl_name )* -> ^( DROP_TABLE ( tbl_name )* ) )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // Fatworm.g:52:5: CREATE TABLE tbl_name '(' create_definition ( ',' create_definition )* ')'
                    {
                    ...
                    {
                        // Fatworm.g:53:8: ^( CREATE_TABLE tbl_name ( create_definition )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
    ...
    // Fatworm.g:58:1: create_definition : ( col_name data_type ( column_definition_suffix )* -> ^( CREATE_DEFINITION col_name data_type ( column_definition_suffix )* ) | PRIMARY KEY '(' col_name ')' -> ^( PRIMARY_KEY col_name ) );
    public final FatwormParser.create_definition_return create_definition() throws RecognitionException {
        ...
        FatwormParser.col_name_return col_name29 =null;

        FatwormParser.data_type_return data_type30 =null;

        FatwormParser.column_definition_suffix_return column_definition_suffix31 =null;

        FatwormParser.col_name_return col_name35 =null;
        ...
        try {
            ...
            // Fatworm.g:59:3: ( col_name data_type ( column_definition_suffix )* -> ^( CREATE_DEFINITION col_name data_type ( column_definition_suffix )* ) | PRIMARY KEY '(' col_name ')' -> ^( PRIMARY_KEY col_name ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    ...
                    {
                        // Fatworm.g:60:8: ^( CREATE_DEFINITION col_name data_type ( column_definition_suffix )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(CREATE_DEFINITION, "CREATE_DEFINITION")
                        , root_1);
                ...
                case 2 :
                    ...
                    // 62:5: -> ^( PRIMARY_KEY col_name )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(PRIMARY_KEY, "PRIMARY_KEY")
                        , root_1);
    ...
    // Fatworm.g:65:1: data_type : ( INT ^| FLOAT ^| CHAR ^ '(' ! INTEGER_LITERAL ')' !| DATETIME ^| BOOLEAN ^| DECIMAL ^ '(' ! INTEGER_LITERAL ( ',' ! INTEGER_LITERAL )? ')' !| TIMESTAMP ^| VARCHAR ^ '(' ! INTEGER_LITERAL ')' !);
    public final FatwormParser.data_type_return data_type() throws RecognitionException {
        ...
        try {
            ...
            // Fatworm.g:66:3: ( INT ^| FLOAT ^| CHAR ^ '(' ! INTEGER_LITERAL ')' !| DATETIME ^| BOOLEAN ^| DECIMAL ^ '(' ! INTEGER_LITERAL ( ',' ! INTEGER_LITERAL )? ')' !| TIMESTAMP ^| VARCHAR ^ '(' ! INTEGER_LITERAL ')' !)
            int alt9=8;
            switch ( input.LA(1) ) {
            case INT:
                {
            ...
            switch (alt9) {
                ...
                case 3 :
                    ...
                    if ( state.backtracking==0 ) {
                    INTEGER_LITERAL41_tree = 
                    (Object)adaptor.create(INTEGER_LITERAL41)
                    ;
                ...
                case 4 :
                    ...
                    if ( state.backtracking==0 ) {
                    DATETIME43_tree = 
                    (Object)adaptor.create(DATETIME43)
                    ;
                ...
                case 5 :
                    ...
                    if ( state.backtracking==0 ) {
                    BOOLEAN44_tree = 
                    (Object)adaptor.create(BOOLEAN44)
                    ;
                    ...
                    break;
                case 6 :
                    // Fatworm.g:71:5: DECIMAL ^ '(' ! INTEGER_LITERAL ( ',' ! INTEGER_LITERAL )? ')' !
                    {
                    root_0 = (Object)adaptor.nil();
                    ...
                    if ( state.backtracking==0 ) {
                    DECIMAL45_tree = 
                    (Object)adaptor.create(DECIMAL45)
                    ;
                    ...
                    if ( state.backtracking==0 ) {
                    INTEGER_LITERAL47_tree = 
                    (Object)adaptor.create(INTEGER_LITERAL47)
                    ;
                    ...
                    switch (alt8) {
                        case 1 :
                            ...
                            if ( state.backtracking==0 ) {
                            INTEGER_LITERAL49_tree = 
                            (Object)adaptor.create(INTEGER_LITERAL49)
                            ;
                ...
                case 7 :
                    ...
                    if ( state.backtracking==0 ) {
                    TIMESTAMP51_tree = 
                    (Object)adaptor.create(TIMESTAMP51)
                    ;
                ...
                case 8 :
                    ...
                    if ( state.backtracking==0 ) {
                    VARCHAR52_tree = 
                    (Object)adaptor.create(VARCHAR52)
                    ;
                    ...
                    if ( state.backtracking==0 ) {
                    INTEGER_LITERAL54_tree = 
                    (Object)adaptor.create(INTEGER_LITERAL54)
                    ;
    ...
    // Fatworm.g:76:1: column_definition_suffix : ( ( NOT )? NULL ^| DEFAULT ^ const_value | AUTO_INCREMENT ^);
    public final FatwormParser.column_definition_suffix_return column_definition_suffix() throws RecognitionException {
        ...
        FatwormParser.const_value_return const_value59 =null;
        ...
        try {
            ...
            // Fatworm.g:77:3: ( ( NOT )? NULL ^| DEFAULT ^ const_value | AUTO_INCREMENT ^)
            int alt11=3;
            switch ( input.LA(1) ) {
            case NOT:
            case NULL:
            ...
            switch (alt11) {
                ...
                case 2 :
                    ...
                    if ( state.backtracking==0 ) {
                    DEFAULT58_tree = 
                    (Object)adaptor.create(DEFAULT58)
                    ;
                ...
                case 3 :
                    ...
                    if ( state.backtracking==0 ) {
                    AUTO_INCREMENT60_tree = 
                    (Object)adaptor.create(AUTO_INCREMENT60)
                    ;
    ...
    // Fatworm.g:82:1: insert_statement : ( INSERT INTO tbl_name values_clause -> ^( INSERT_VALUES tbl_name values_clause ) | INSERT INTO tbl_name '(' col_name ( ',' col_name )* ')' values_clause -> ^( INSERT_COLUMNS tbl_name ( col_name )* values_clause ) | INSERT INTO tbl_name '(' subquery ')' -> ^( INSERT_SUBQUERY tbl_name subquery ) );
    public final FatwormParser.insert_statement_return insert_statement() throws RecognitionException {
        ...
        FatwormParser.tbl_name_return tbl_name63 =null;

        FatwormParser.values_clause_return values_clause64 =null;

        FatwormParser.tbl_name_return tbl_name67 =null;

        FatwormParser.col_name_return col_name69 =null;

        FatwormParser.col_name_return col_name71 =null;

        FatwormParser.values_clause_return values_clause73 =null;

        FatwormParser.tbl_name_return tbl_name76 =null;

        FatwormParser.subquery_return subquery78 =null;
        ...
        try {
            ...
            // Fatworm.g:83:3: ( INSERT INTO tbl_name values_clause -> ^( INSERT_VALUES tbl_name values_clause ) | INSERT INTO tbl_name '(' col_name ( ',' col_name )* ')' values_clause -> ^( INSERT_COLUMNS tbl_name ( col_name )* values_clause ) | INSERT INTO tbl_name '(' subquery ')' -> ^( INSERT_SUBQUERY tbl_name subquery ) )
            int alt13=3;
            ...
            switch (alt13) {
                case 1 :
                    ...
                    {
                        // Fatworm.g:84:8: ^( INSERT_VALUES tbl_name values_clause )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(INSERT_VALUES, "INSERT_VALUES")
                        , root_1);
                    ...
                    break;
                case 2 :
                    // Fatworm.g:85:5: INSERT INTO tbl_name '(' col_name ( ',' col_name )* ')' values_clause
                    {
                    ...
                    {
                        // Fatworm.g:86:8: ^( INSERT_COLUMNS tbl_name ( col_name )* values_clause )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(INSERT_COLUMNS, "INSERT_COLUMNS")
                        , root_1);
                ...
                case 3 :
                    ...
                    // 88:5: -> ^( INSERT_SUBQUERY tbl_name subquery )
                    {
                        ...
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(INSERT_SUBQUERY, "INSERT_SUBQUERY")
                        , root_1);
    ...
    public final FatwormParser.values_clause_return values_clause() throws RecognitionException {
        ...
        FatwormParser.value_return value82 =null;

        FatwormParser.value_return value84 =null;
        ...
        try {
            ...
            if ( state.backtracking==0 ) {
            VALUES80_tree = 
            (Object)adaptor.create(VALUES80)
            ;
    ...
    // Fatworm.g:95:1: delete_statement : DELETE ^ FROM ! tbl_name ( where_clause )? ;
    public final FatwormParser.delete_statement_return delete_statement() throws RecognitionException {
        ...
        Token DELETE86=null;
        Token FROM87=null;
        FatwormParser.tbl_name_return tbl_name88 =null;

        FatwormParser.where_clause_return where_clause89 =null;
        ...
        try {
            ...
            if ( state.backtracking==0 ) {
            DELETE86_tree = 
            (Object)adaptor.create(DELETE86)
            ;
    ...
    // Fatworm.g:99:1: update_statement : UPDATE ^ tbl_name SET ! update_pair ( ',' ! update_pair )* ( where_clause )? ;
    public final FatwormParser.update_statement_return update_statement() throws RecognitionException {
        ...
        FatwormParser.tbl_name_return tbl_name91 =null;

        FatwormParser.update_pair_return update_pair93 =null;

        FatwormParser.update_pair_return update_pair95 =null;

        FatwormParser.where_clause_return where_clause96 =null;
        ...
        try {
            ...
            // Fatworm.g:100:3: ( UPDATE ^ tbl_name SET ! update_pair ( ',' ! update_pair )* ( where_clause )? )
            // Fatworm.g:100:5: UPDATE ^ tbl_name SET ! update_pair ( ',' ! update_pair )* ( where_clause )?
            {
            root_0 = (Object)adaptor.nil();
            ...
            if ( state.backtracking==0 ) {
            UPDATE90_tree = 
            (Object)adaptor.create(UPDATE90)
            ;
    ...
    // Fatworm.g:103:1: update_pair : col_name '=' value -> ^( UPDATE_PAIR col_name value ) ;
    public final FatwormParser.update_pair_return update_pair() throws RecognitionException {
        ...
        FatwormParser.col_name_return col_name97 =null;

        FatwormParser.value_return value99 =null;
        ...
        try {
            ...
            // Fatworm.g:104:3: ( col_name '=' value -> ^( UPDATE_PAIR col_name value ) )
            ...
            // 105:5: -> ^( UPDATE_PAIR col_name value )
            {
                ...
                Object root_1 = (Object)adaptor.nil();
                root_1 = (Object)adaptor.becomeRoot(
                (Object)adaptor.create(UPDATE_PAIR, "UPDATE_PAIR")
                , root_1);
    ...
    // Fatworm.g:108:1: index_statement : ( CREATE INDEX index_name ON tbl_name '(' col_name ')' -> ^( CREATE_INDEX index_name tbl_name col_name ) | CREATE UNIQUE INDEX index_name ON tbl_name '(' col_name ')' -> ^( CREATE_UNIQUE_INDEX index_name tbl_name col_name ) | DROP INDEX index_name ON tbl_name -> ^( DROP_INDEX index_name tbl_name ) );
    public final FatwormParser.index_statement_return index_statement() throws RecognitionException {
        ...
        Token INDEX118=null;
        Token ON120=null;
        FatwormParser.index_name_return index_name102 =null;

        FatwormParser.tbl_name_return tbl_name104 =null;

        FatwormParser.col_name_return col_name106 =null;

        FatwormParser.index_name_return index_name111 =null;

        FatwormParser.tbl_name_return tbl_name113 =null;

        FatwormParser.col_name_return col_name115 =null;

        FatwormParser.index_name_return index_name119 =null;

        FatwormParser.tbl_name_return tbl_name121 =null;
        ...
        try {
            ...
            // Fatworm.g:109:3: ( CREATE INDEX index_name ON tbl_name '(' col_name ')' -> ^( CREATE_INDEX index_name tbl_name col_name ) | CREATE UNIQUE INDEX index_name ON tbl_name '(' col_name ')' -> ^( CREATE_UNIQUE_INDEX index_name tbl_name col_name ) | DROP INDEX index_name ON tbl_name -> ^( DROP_INDEX index_name tbl_name ) )
            int alt18=3;
            ...
            switch (alt18) {
                case 1 :
                    ...
                    {
                        // Fatworm.g:110:8: ^( CREATE_INDEX index_name tbl_name col_name )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                    ...
                    break;
                case 2 :
                    // Fatworm.g:111:5: CREATE UNIQUE INDEX index_name ON tbl_name '(' col_name ')'
                    {
                    ...
                    {
                        // Fatworm.g:112:8: ^( CREATE_UNIQUE_INDEX index_name tbl_name col_name )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                        (Object)adaptor.create(CREATE_UNIQUE_INDEX, "CREATE_UNIQUE_INDEX")
                        , root_1);
    ...
    // Fatworm.g:117:1: select_statement : ( SELECT select_expr ( ',' select_expr )* ( select_suffix )* -> ^( SELECT ( select_expr )* ( select_suffix )* ) | SELECT DISTINCT select_expr ( ',' select_expr )* ( select_suffix )* -> ^( SELECT_DISTINCT ( select_expr )* ( select_suffix )* ) );
    public final FatwormParser.select_statement_return select_statement() throws RecognitionException {
        ...
        FatwormParser.select_expr_return select_expr123 =null;

        FatwormParser.select_expr_return select_expr125 =null;

        FatwormParser.select_suffix_return select_suffix126 =null;

        FatwormParser.select_expr_return select_expr129 =null;

        FatwormParser.select_expr_return select_expr131 =null;

        FatwormParser.select_suffix_return select_suffix132 =null;
        ...
        try {
            ...
            // Fatworm.g:118:3: ( SELECT select_expr ( ',' select_expr )* ( select_suffix )* -> ^( SELECT ( select_expr )* ( select_suffix )* ) | SELECT DISTINCT select_expr ( ',' select_expr )* ( select_suffix )* -> ^( SELECT_DISTINCT ( select_expr )* ( select_suffix )* ) )
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // Fatworm.g:118:5: SELECT select_expr ( ',' select_expr )* ( select_suffix )*
                    {
                    ...
                    {
                        // Fatworm.g:119:8: ^( SELECT ( select_expr )* ( select_suffix )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
                    ...
                    break;
                case 2 :
                    // Fatworm.g:120:5: SELECT DISTINCT select_expr ( ',' select_expr )* ( select_suffix )*
                    {
                    ...
                    {
                        // Fatworm.g:121:8: ^( SELECT_DISTINCT ( select_expr )* ( select_suffix )* )
                        {
                        Object root_1 = (Object)adaptor.nil();
                        root_1 = (Object)adaptor.becomeRoot(
    ...
    // Fatworm.g:124:1: select_suffix : ( from_clause | where_clause | group_by_clause | having_clause | order_by_clause );
    public final FatwormParser.select_suffix_return select_suffix() throws RecognitionException {
        ...
        FatwormParser.from_clause_return from_clause133 =null;

        FatwormParser.where_clause_return where_clause134 =null;

        FatwormParser.group_by_clause_return group_by_clause135 =null;

        FatwormParser.having_clause_return having_clause136 =null;

        FatwormParser.order_by_clause_return order_by_clause137 =null;
        ...
        try {
            ...
            // Fatworm.g:125:3: ( from_clause | where_clause | group_by_clause | having_clause | order_by_clause )
            int alt24=5;
            switch ( input.LA(1) ) {
            case FROM:
                {
    ...
    public final FatwormParser.from_clause_return from_clause() throws RecognitionException {
        ...
        FatwormParser.tbl_ref_return tbl_ref139 =null;

        FatwormParser.tbl_ref_return tbl_ref141 =null;
        ...
        try {
            ...
            FROM138=(Token)match(input,FROM,FOLLOW_FROM_in_from_clause978); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            FROM138_tree = 
            (Object)adaptor.create(FROM138)
            ;
    ...
    public final FatwormParser.where_clause_return where_clause() throws RecognitionException {
        ...
        Token WHERE142=null;
        FatwormParser.where_condition_return where_condition143 =null;
        ...
        try {
            ...
            WHERE142=(Token)match(input,WHERE,FOLLOW_WHERE_in_where_clause1002); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            WHERE142_tree = 
            (Object)adaptor.create(WHERE142)
            ;
    ...
    public final FatwormParser.group_by_clause_return group_by_clause() throws RecognitionException {
        ...
        Token GROUP144=null;
        Token BY145=null;
        FatwormParser.col_name_return col_name146 =null;
        ...
        try {
            ...
            GROUP144=(Token)match(input,GROUP,FOLLOW_GROUP_in_group_by_clause1018); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            GROUP144_tree = 
            (Object)adaptor.create(GROUP144)
            ;
            root_0 = (Object)adaptor.becomeRoot(GROUP144_tree, root_0);
            }

            BY145=(Token)match(input,BY,FOLLOW_BY_in_group_by_clause1021); if (state.failed) return retval;
    ...
    public final FatwormParser.having_clause_return having_clause() throws RecognitionException {
        ...
        FatwormParser.having_condition_return having_condition148 =null;
        ...
        try {
            ...
            HAVING147=(Token)match(input,HAVING,FOLLOW_HAVING_in_having_clause1037); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            HAVING147_tree = 
            (Object)adaptor.create(HAVING147)
            ;
    ...
    // Fatworm.g:148:1: order_by_clause : ORDER ^ BY ! order_by_col_name ( ',' ! order_by_col_name )* ;
    public final FatwormParser.order_by_clause_return order_by_clause() throws RecognitionException {
        ...
        FatwormParser.order_by_col_name_return order_by_col_name151 =null;

        FatwormParser.order_by_col_name_return order_by_col_name153 =null;
        ...
        try {
            ...
            // Fatworm.g:149:3: ( ORDER ^ BY ! order_by_col_name ( ',' ! order_by_col_name )* )
            // Fatworm.g:149:5: ORDER ^ BY ! order_by_col_name ( ',' ! order_by_col_name )*
            {
            root_0 = (Object)adaptor.nil();


            ORDER149=(Token)match(input,ORDER,FOLLOW_ORDER_in_order_by_clause1053); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ORDER149_tree = 
            (Object)adaptor.create(ORDER149)
            ;
            root_0 = (Object)adaptor.becomeRoot(ORDER149_tree, root_0);
            }

            BY150=(Token)match(input,BY,FOLLOW_BY_in_order_by_clause1056); if (state.failed) return retval;
    ...
    // Fatworm.g:152:1: order_by_col_name : ( col_name ASC ^| col_name DESC ^| col_name );
    public final FatwormParser.order_by_col_name_return order_by_col_name() throws RecognitionException {
        ...
        Token ASC155=null;
        Token DESC157=null;
        FatwormParser.col_name_return col_name154 =null;

        FatwormParser.col_name_return col_name156 =null;

        FatwormParser.col_name_return col_name158 =null;
        ...
        try {
            ...
            switch (alt27) {
                case 1 :
                    ...
                    ASC155=(Token)match(input,ASC,FOLLOW_ASC_in_order_by_col_name1082); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ASC155_tree = 
                    (Object)adaptor.create(ASC155)
                    ;
                ...
                case 2 :
                    ...
                    DESC157=(Token)match(input,DESC,FOLLOW_DESC_in_order_by_col_name1091); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    DESC157_tree = 
                    (Object)adaptor.create(DESC157)
                    ;
    ...
    public final FatwormParser.select_expr_return select_expr() throws RecognitionException {
        ...
        FatwormParser.value_return value159 =null;

        FatwormParser.alias_return alias161 =null;
        ...
        try {
            ...
            switch (alt29) {
                ...
                case 2 :
                    ...
                    char_literal162=(Token)match(input,108,FOLLOW_108_in_select_expr1125); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    public final FatwormParser.col_name_return col_name() throws RecognitionException {
        ...
        FatwormParser.tbl_name_return tbl_name164 =null;

        FatwormParser.name_return name166 =null;
        ...
        try {
            ...
            switch (alt30) {
                case 1 :
                    ...
                    char_literal165=(Token)match(input,112,FOLLOW_112_in_col_name1171); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // $ANTLR start "tbl_ref"
    // Fatworm.g:171:1: tbl_ref : ( tbl_name ( AS ^ alias )? | '(' ! subquery ')' ! AS ^ alias );
    public final FatwormParser.tbl_ref_return tbl_ref() throws RecognitionException {
        ...
        Token AS173=null;
        FatwormParser.tbl_name_return tbl_name167 =null;

        FatwormParser.alias_return alias169 =null;

        FatwormParser.subquery_return subquery171 =null;

        FatwormParser.alias_return alias174 =null;
        ...
        try {
            ...
            // Fatworm.g:172:3: ( tbl_name ( AS ^ alias )? | '(' ! subquery ')' ! AS ^ alias )
            int alt32=2;
            ...
            switch (alt32) {
                ...
                case 2 :
                    ...
                    char_literal170=(Token)match(input,106,FOLLOW_106_in_tbl_ref1203); if (state.failed) return retval;
                    ...
                    char_literal172=(Token)match(input,107,FOLLOW_107_in_tbl_ref1208); if (state.failed) return retval;

                    AS173=(Token)match(input,AS,FOLLOW_AS_in_tbl_ref1211); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    AS173_tree = 
                    (Object)adaptor.create(AS173)
                    ;
    ...
    public final FatwormParser.tbl_name_return tbl_name() throws RecognitionException {
        ...
        FatwormParser.name_return name175 =null;
    ...
    public final FatwormParser.alias_return alias() throws RecognitionException {
        ...
        FatwormParser.name_return name176 =null;

        FatwormParser.func_return func177 =null;
    ...
    public final FatwormParser.index_name_return index_name() throws RecognitionException {
        ...
        FatwormParser.name_return name178 =null;
    ...
    public final FatwormParser.db_name_return db_name() throws RecognitionException {
        ...
        FatwormParser.name_return name179 =null;
    ...
    public final FatwormParser.name_return name() throws RecognitionException {
        ...
        try {
            ...
            ID180=(Token)match(input,ID,FOLLOW_ID_in_name1285); if (state.failed) return retval;
            if ( state.backtracking==0 ) {
            ID180_tree = 
    ...
    public final FatwormParser.where_condition_return where_condition() throws RecognitionException {
        ...
        FatwormParser.bool_expr_return bool_expr181 =null;
    ...
    public final FatwormParser.having_condition_return having_condition() throws RecognitionException {
        ...
        FatwormParser.bool_expr_return bool_expr182 =null;
    ...
    public final FatwormParser.subquery_return subquery() throws RecognitionException {
        ...
        FatwormParser.select_statement_return select_statement183 =null;
    ...
    public final FatwormParser.bool_expr_return bool_expr() throws RecognitionException {
        ...
        FatwormParser.logical_or_return logical_or184 =null;
    ...
    // Fatworm.g:213:1: logical_or : ( logical_and ( OR ^ logical_and )+ | logical_and );
    public final FatwormParser.logical_or_return logical_or() throws RecognitionException {
        ...
        try {
            ...
            // Fatworm.g:214:3: ( logical_and ( OR ^ logical_and )+ | logical_and )
            int alt35=2;
    ...
    public final FatwormParser.logical_and_return logical_and() throws RecognitionException {
        ...
        Token AND190=null;
        FatwormParser.primary_return primary189 =null;

        FatwormParser.primary_return primary191 =null;

        FatwormParser.primary_return primary192 =null;
    ...
    // $ANTLR start "primary"
    // Fatworm.g:223:1: primary : ( value cop ^ value | NOT EXISTS '(' subquery ')' -> ^( NOT_EXISTS subquery ) | EXISTS ^ '(' ! subquery ')' !| value IN ^ '(' ! subquery ')' !| value cop ANY ^ '(' ! subquery ')' !| value cop ALL ^ '(' ! subquery ')' !| '(' ! bool_expr ')' !);
    public final FatwormParser.primary_return primary() throws RecognitionException {
        ...
        FatwormParser.value_return value193 =null;

        FatwormParser.cop_return cop194 =null;

        FatwormParser.value_return value195 =null;

        FatwormParser.subquery_return subquery199 =null;

        FatwormParser.subquery_return subquery203 =null;

        FatwormParser.value_return value205 =null;

        FatwormParser.subquery_return subquery208 =null;

        FatwormParser.value_return value210 =null;

        FatwormParser.cop_return cop211 =null;

        FatwormParser.subquery_return subquery214 =null;

        FatwormParser.value_return value216 =null;

        FatwormParser.cop_return cop217 =null;

        FatwormParser.subquery_return subquery220 =null;

        FatwormParser.bool_expr_return bool_expr223 =null;
        ...
        try {
            ...
            // Fatworm.g:224:3: ( value cop ^ value | NOT EXISTS '(' subquery ')' -> ^( NOT_EXISTS subquery ) | EXISTS ^ '(' ! subquery ')' !| value IN ^ '(' ! subquery ')' !| value cop ANY ^ '(' ! subquery ')' !| value cop ALL ^ '(' ! subquery ')' !| '(' ! bool_expr ')' !)
            int alt38=7;
            switch ( input.LA(1) ) {
            case 106:
                {
            ...
            switch (alt38) {
                ...
                case 2 :
                    ...
                    EXISTS197=(Token)match(input,EXISTS,FOLLOW_EXISTS_in_primary1417); if (state.failed) return retval; 
                    if ( state.backtracking==0 ) stream_EXISTS.add(EXISTS197);


                    char_literal198=(Token)match(input,106,FOLLOW_106_in_primary1419); if (state.failed) return retval; 
                    ...
                    char_literal200=(Token)match(input,107,FOLLOW_107_in_primary1423); if (state.failed) return retval; 
                ...
                case 3 :
                    ...
                    EXISTS201=(Token)match(input,EXISTS,FOLLOW_EXISTS_in_primary1441); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    EXISTS201_tree = 
                    (Object)adaptor.create(EXISTS201)
                    ;
                    root_0 = (Object)adaptor.becomeRoot(EXISTS201_tree, root_0);
                    }

                    char_literal202=(Token)match(input,106,FOLLOW_106_in_primary1444); if (state.failed) return retval;
                    ...
                    char_literal204=(Token)match(input,107,FOLLOW_107_in_primary1449); if (state.failed) return retval;
                ...
                case 4 :
                    ...
                    IN206=(Token)match(input,IN,FOLLOW_IN_in_primary1458); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    IN206_tree = 
                    (Object)adaptor.create(IN206)
                    ;
                    root_0 = (Object)adaptor.becomeRoot(IN206_tree, root_0);
                    }

                    char_literal207=(Token)match(input,106,FOLLOW_106_in_primary1461); if (state.failed) return retval;
                    ...
                    char_literal209=(Token)match(input,107,FOLLOW_107_in_primary1466); if (state.failed) return retval;
                ...
                case 5 :
                    ...
                    ANY212=(Token)match(input,ANY,FOLLOW_ANY_in_primary1477); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ANY212_tree = 
                    ...
                    char_literal213=(Token)match(input,106,FOLLOW_106_in_primary1480); if (state.failed) return retval;
                    ...
                    char_literal215=(Token)match(input,107,FOLLOW_107_in_primary1485); if (state.failed) return retval;
                ...
                case 6 :
                    ...
                    ALL218=(Token)match(input,ALL,FOLLOW_ALL_in_primary1496); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
                    ALL218_tree = 
                    (Object)adaptor.create(ALL218)
                    ;
                    root_0 = (Object)adaptor.becomeRoot(ALL218_tree, root_0);
                    }

                    char_literal219=(Token)match(input,106,FOLLOW_106_in_primary1499); if (state.failed) return retval;
                    ...
                    char_literal221=(Token)match(input,107,FOLLOW_107_in_primary1504); if (state.failed) return retval;
                ...
                case 7 :
                    ...
                    char_literal222=(Token)match(input,106,FOLLOW_106_in_primary1511); if (state.failed) return retval;
                    ...
                    char_literal224=(Token)match(input,107,FOLLOW_107_in_primary1516); if (state.failed) return retval;
    ...
    // $ANTLR start "value"
    // Fatworm.g:238:1: value : ( multiplicative ( ( '+' | '-' ) ^ multiplicative )+ | multiplicative );
    public final FatwormParser.value_return value() throws RecognitionException {
        ...
        Token set227=null;
        FatwormParser.multiplicative_return multiplicative226 =null;

        FatwormParser.multiplicative_return multiplicative228 =null;

        FatwormParser.multiplicative_return multiplicative229 =null;
        ...
        try {
            ...
            // Fatworm.g:239:3: ( multiplicative ( ( '+' | '-' ) ^ multiplicative )+ | multiplicative )
            int alt40=2;
    ...
    // Fatworm.g:243:1: multiplicative : ( atom ( ( '*' | '/' | '%' ) ^ atom )+ | atom );
    public final FatwormParser.multiplicative_return multiplicative() throws RecognitionException {
        ...
        Token set231=null;
        FatwormParser.atom_return atom230 =null;

        FatwormParser.atom_return atom232 =null;

        FatwormParser.atom_return atom233 =null;
    ...
    // $ANTLR start "atom"
    // Fatworm.g:248:1: atom : ( '(' ! value ')' !| col_name | const_value | '(' ! subquery ')' !| func ^ '(' ! col_name ')' !| '-' ^ atom );
    public final FatwormParser.atom_return atom() throws RecognitionException {
        ...
        FatwormParser.value_return value235 =null;

        FatwormParser.col_name_return col_name237 =null;

        FatwormParser.const_value_return const_value238 =null;

        FatwormParser.subquery_return subquery240 =null;

        FatwormParser.func_return func242 =null;

        FatwormParser.col_name_return col_name244 =null;

        FatwormParser.atom_return atom247 =null;
        ...
        try {
            ...
            // Fatworm.g:249:3: ( '(' ! value ')' !| col_name | const_value | '(' ! subquery ')' !| func ^ '(' ! col_name ')' !| '-' ^ atom )
            int alt43=6;
            switch ( input.LA(1) ) {
            case 106:
                {
            ...
            switch (alt43) {
                case 1 :
                    ...
                    char_literal234=(Token)match(input,106,FOLLOW_106_in_atom1627); if (state.failed) return retval;
                    ...
                    char_literal236=(Token)match(input,107,FOLLOW_107_in_atom1632); if (state.failed) return retval;
                ...
                case 4 :
                    ...
                    char_literal239=(Token)match(input,106,FOLLOW_106_in_atom1651); if (state.failed) return retval;
                    ...
                    char_literal241=(Token)match(input,107,FOLLOW_107_in_atom1656); if (state.failed) return retval;
                ...
                case 5 :
                    ...
                    char_literal243=(Token)match(input,106,FOLLOW_106_in_atom1666); if (state.failed) return retval;
                    ...
                    char_literal245=(Token)match(input,107,FOLLOW_107_in_atom1671); if (state.failed) return retval;
                ...
                case 6 :
                    ...
                    char_literal246=(Token)match(input,111,FOLLOW_111_in_atom1678); if (state.failed) return retval;
                    if ( state.backtracking==0 ) {
    ...
    // Fatworm.g:257:1: const_value : ( INTEGER_LITERAL | STRING_LITERAL | FLOAT_LITERAL | TRUE | FALSE | NULL | DEFAULT );
    public final FatwormParser.const_value_return const_value() throws RecognitionException {
        ...
        try {
            ...
            // Fatworm.g:258:3: ( INTEGER_LITERAL | STRING_LITERAL | FLOAT_LITERAL | TRUE | FALSE | NULL | DEFAULT )
            // Fatworm.g:
            {
            root_0 = (Object)adaptor.nil();
    ...
    public final void synpred45_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,ASC,FOLLOW_ASC_in_synpred45_Fatworm1082); if (state.failed) return ;
    ...
    public final void synpred46_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,DESC,FOLLOW_DESC_in_synpred46_Fatworm1091); if (state.failed) return ;
    ...
    public final void synpred53_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,112,FOLLOW_112_in_synpred53_Fatworm1171); if (state.failed) return ;
    ...
    public final void synpred64_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,IN,FOLLOW_IN_in_synpred64_Fatworm1458); if (state.failed) return ;

        match(input,106,FOLLOW_106_in_synpred64_Fatworm1461); if (state.failed) return ;
        ...
        match(input,107,FOLLOW_107_in_synpred64_Fatworm1466); if (state.failed) return ;
    ...
    public final void synpred65_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,ANY,FOLLOW_ANY_in_synpred65_Fatworm1477); if (state.failed) return ;

        match(input,106,FOLLOW_106_in_synpred65_Fatworm1480); if (state.failed) return ;
        ...
        match(input,107,FOLLOW_107_in_synpred65_Fatworm1485); if (state.failed) return ;
    ...
    public final void synpred66_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,ALL,FOLLOW_ALL_in_synpred66_Fatworm1496); if (state.failed) return ;

        match(input,106,FOLLOW_106_in_synpred66_Fatworm1499); if (state.failed) return ;
        ...
        match(input,107,FOLLOW_107_in_synpred66_Fatworm1504); if (state.failed) return ;
    ...
    public final void synpred79_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,107,FOLLOW_107_in_synpred79_Fatworm1632); if (state.failed) return ;
    ...
    public final void synpred82_Fatworm_fragment() throws RecognitionException {
        ...
        match(input,107,FOLLOW_107_in_synpred82_Fatworm1656); if (state.failed) return ;
    ...
    public static final BitSet FOLLOW_select_expr_in_select_statement866 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    public static final BitSet FOLLOW_110_in_select_statement869 = new BitSet(new long[]{0x0202050010020800L,0x0000940002300046L});
    public static final BitSet FOLLOW_select_expr_in_select_statement871 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    public static final BitSet FOLLOW_select_suffix_in_select_statement875 = new BitSet(new long[]{0x0000A80000000002L,0x0000001000000400L});
    ...
    public static final BitSet FOLLOW_select_expr_in_select_statement902 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    public static final BitSet FOLLOW_110_in_select_statement905 = new BitSet(new long[]{0x0202050010020800L,0x0000940002300046L});
    public static final BitSet FOLLOW_select_expr_in_select_statement907 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    public static final BitSet FOLLOW_select_suffix_in_select_statement911 = new BitSet(new long[]{0x0000A80000000002L,0x0000001000000400L});
    public static final BitSet FOLLOW_from_clause_in_select_suffix941 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_where_clause_in_select_suffix947 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_group_by_clause_in_select_suffix953 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_having_clause_in_select_suffix959 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_order_by_clause_in_select_suffix965 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_FROM_in_from_clause978 = new BitSet(new long[]{0x0002000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_tbl_ref_in_from_clause981 = new BitSet(new long[]{0x0000000000000002L,0x0000400000000000L});
    public static final BitSet FOLLOW_110_in_from_clause984 = new BitSet(new long[]{0x0002000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_tbl_ref_in_from_clause987 = new BitSet(new long[]{0x0000000000000002L,0x0000400000000000L});
    public static final BitSet FOLLOW_WHERE_in_where_clause1002 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_where_condition_in_where_clause1005 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_GROUP_in_group_by_clause1018 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_BY_in_group_by_clause1021 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_col_name_in_group_by_clause1024 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_HAVING_in_having_clause1037 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_having_condition_in_having_clause1040 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ORDER_in_order_by_clause1053 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_BY_in_order_by_clause1056 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_order_by_col_name_in_order_by_clause1059 = new BitSet(new long[]{0x0000000000000002L,0x0000400000000000L});
    public static final BitSet FOLLOW_110_in_order_by_clause1062 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_order_by_col_name_in_order_by_clause1065 = new BitSet(new long[]{0x0000000000000002L,0x0000400000000000L});
    public static final BitSet FOLLOW_col_name_in_order_by_col_name1080 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_ASC_in_order_by_col_name1082 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_col_name_in_order_by_col_name1089 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_DESC_in_order_by_col_name1091 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_col_name_in_order_by_col_name1098 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_select_expr1111 = new BitSet(new long[]{0x0000000000000102L});
    public static final BitSet FOLLOW_AS_in_select_expr1114 = new BitSet(new long[]{0x0002000000020800L,0x0000000000200006L});
    public static final BitSet FOLLOW_alias_in_select_expr1117 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_108_in_select_expr1125 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_tbl_name_in_col_name1169 = new BitSet(new long[]{0x0000000000000000L,0x0001000000000000L});
    public static final BitSet FOLLOW_112_in_col_name1171 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_name_in_col_name1176 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_tbl_name_in_tbl_ref1189 = new BitSet(new long[]{0x0000000000000102L});
    public static final BitSet FOLLOW_AS_in_tbl_ref1192 = new BitSet(new long[]{0x0002000000020800L,0x0000000000200006L});
    public static final BitSet FOLLOW_alias_in_tbl_ref1195 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_tbl_ref1203 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_tbl_ref1206 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_tbl_ref1208 = new BitSet(new long[]{0x0000000000000100L});
    public static final BitSet FOLLOW_AS_in_tbl_ref1211 = new BitSet(new long[]{0x0002000000020800L,0x0000000000200006L});
    public static final BitSet FOLLOW_alias_in_tbl_ref1214 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_name_in_tbl_name1227 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_name_in_alias1240 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_func_in_alias1246 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_name_in_index_name1259 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_name_in_db_name1272 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_name1285 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bool_expr_in_where_condition1298 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_bool_expr_in_having_condition1311 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_select_statement_in_subquery1324 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_logical_or_in_bool_expr1337 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_logical_and_in_logical_or1350 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_OR_in_logical_or1353 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_logical_and_in_logical_or1356 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000200L});
    public static final BitSet FOLLOW_logical_and_in_logical_or1364 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_primary_in_logical_and1377 = new BitSet(new long[]{0x0000000000000040L});
    public static final BitSet FOLLOW_AND_in_logical_and1380 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_primary_in_logical_and1383 = new BitSet(new long[]{0x0000000000000042L});
    public static final BitSet FOLLOW_primary_in_logical_and1391 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_primary1404 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_primary1406 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_value_in_primary1409 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_NOT_in_primary1415 = new BitSet(new long[]{0x0000004000000000L});
    public static final BitSet FOLLOW_EXISTS_in_primary1417 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_primary1419 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_primary1421 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1423 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_EXISTS_in_primary1441 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_primary1444 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_primary1447 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1449 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_primary1456 = new BitSet(new long[]{0x0004000000000000L});
    public static final BitSet FOLLOW_IN_in_primary1458 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_primary1461 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_primary1464 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1466 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_primary1473 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_primary1475 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ANY_in_primary1477 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_primary1480 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_primary1483 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_primary1492 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_primary1494 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_ALL_in_primary1496 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_primary1499 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_primary1502 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1504 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_primary1511 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_bool_expr_in_primary1514 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_primary1516 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_multiplicative_in_value1563 = new BitSet(new long[]{0x0000000000000000L,0x0000A00000000000L});
    public static final BitSet FOLLOW_set_in_value1566 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_multiplicative_in_value1573 = new BitSet(new long[]{0x0000000000000002L,0x0000A00000000000L});
    public static final BitSet FOLLOW_multiplicative_in_value1581 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_atom_in_multiplicative1594 = new BitSet(new long[]{0x0000000000000000L,0x0002120000000000L});
    public static final BitSet FOLLOW_set_in_multiplicative1597 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_atom_in_multiplicative1606 = new BitSet(new long[]{0x0000000000000002L,0x0002120000000000L});
    public static final BitSet FOLLOW_atom_in_multiplicative1614 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_atom1627 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_value_in_atom1630 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_atom1632 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_col_name_in_atom1639 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_const_value_in_atom1645 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_atom1651 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_atom1654 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_atom1656 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_func_in_atom1663 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_atom1666 = new BitSet(new long[]{0x0002000000000000L});
    public static final BitSet FOLLOW_col_name_in_atom1669 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_atom1671 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_111_in_atom1678 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_atom_in_atom1681 = new BitSet(new long[]{0x0000000000000002L});
    ...
    public static final BitSet FOLLOW_select_expr_in_synpred36_Fatworm866 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    ...
    public static final BitSet FOLLOW_select_expr_in_synpred36_Fatworm871 = new BitSet(new long[]{0x0000A80000000002L,0x0000401000000400L});
    public static final BitSet FOLLOW_select_suffix_in_synpred36_Fatworm875 = new BitSet(new long[]{0x0000A80000000002L,0x0000001000000400L});
    public static final BitSet FOLLOW_col_name_in_synpred45_Fatworm1080 = new BitSet(new long[]{0x0000000000000200L});
    public static final BitSet FOLLOW_ASC_in_synpred45_Fatworm1082 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_col_name_in_synpred46_Fatworm1089 = new BitSet(new long[]{0x0000000040000000L});
    public static final BitSet FOLLOW_DESC_in_synpred46_Fatworm1091 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_tbl_name_in_synpred53_Fatworm1169 = new BitSet(new long[]{0x0000000000000000L,0x0001000000000000L});
    public static final BitSet FOLLOW_112_in_synpred53_Fatworm1171 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_logical_and_in_synpred58_Fatworm1350 = new BitSet(new long[]{0x0000000000000000L,0x0000000000000200L});
    public static final BitSet FOLLOW_OR_in_synpred58_Fatworm1353 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_logical_and_in_synpred58_Fatworm1356 = new BitSet(new long[]{0x0000000000000002L,0x0000000000000200L});
    public static final BitSet FOLLOW_primary_in_synpred60_Fatworm1377 = new BitSet(new long[]{0x0000000000000040L});
    public static final BitSet FOLLOW_AND_in_synpred60_Fatworm1380 = new BitSet(new long[]{0x0202054010020800L,0x0000840002300056L});
    public static final BitSet FOLLOW_primary_in_synpred60_Fatworm1383 = new BitSet(new long[]{0x0000000000000042L});
    public static final BitSet FOLLOW_value_in_synpred61_Fatworm1404 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_synpred61_Fatworm1406 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_value_in_synpred61_Fatworm1409 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_synpred64_Fatworm1456 = new BitSet(new long[]{0x0004000000000000L});
    public static final BitSet FOLLOW_IN_in_synpred64_Fatworm1458 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_synpred64_Fatworm1461 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_synpred64_Fatworm1464 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_synpred64_Fatworm1466 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_synpred65_Fatworm1473 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_synpred65_Fatworm1475 = new BitSet(new long[]{0x0000000000000080L});
    public static final BitSet FOLLOW_ANY_in_synpred65_Fatworm1477 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_synpred65_Fatworm1480 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_synpred65_Fatworm1483 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_synpred65_Fatworm1485 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_value_in_synpred66_Fatworm1492 = new BitSet(new long[]{0x0000000000000000L,0x00FC000000000000L});
    public static final BitSet FOLLOW_cop_in_synpred66_Fatworm1494 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_ALL_in_synpred66_Fatworm1496 = new BitSet(new long[]{0x0000000000000000L,0x0000040000000000L});
    public static final BitSet FOLLOW_106_in_synpred66_Fatworm1499 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_synpred66_Fatworm1502 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_synpred66_Fatworm1504 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_multiplicative_in_synpred74_Fatworm1563 = new BitSet(new long[]{0x0000000000000000L,0x0000A00000000000L});
    public static final BitSet FOLLOW_set_in_synpred74_Fatworm1566 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_multiplicative_in_synpred74_Fatworm1573 = new BitSet(new long[]{0x0000000000000002L,0x0000A00000000000L});
    public static final BitSet FOLLOW_atom_in_synpred78_Fatworm1594 = new BitSet(new long[]{0x0000000000000000L,0x0002120000000000L});
    public static final BitSet FOLLOW_set_in_synpred78_Fatworm1597 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_atom_in_synpred78_Fatworm1606 = new BitSet(new long[]{0x0000000000000002L,0x0002120000000000L});
    public static final BitSet FOLLOW_106_in_synpred79_Fatworm1627 = new BitSet(new long[]{0x0202050010020800L,0x0000840002300046L});
    public static final BitSet FOLLOW_value_in_synpred79_Fatworm1630 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_synpred79_Fatworm1632 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_106_in_synpred82_Fatworm1651 = new BitSet(new long[]{0x0000000000000000L,0x0000000000020000L});
    public static final BitSet FOLLOW_subquery_in_synpred82_Fatworm1654 = new BitSet(new long[]{0x0000000000000000L,0x0000080000000000L});
    public static final BitSet FOLLOW_107_in_synpred82_Fatworm1656 = new BitSet(new long[]{0x0000000000000002L});
